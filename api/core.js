...
class GeminiManager {
    ...
    async transcribeAudioWithEmotion(audioBuffer) {
        ...
        const operation = async () => {
            ...
            const prompt = "אתה מערכת לתמלול חכמה. המטרה שלך היא לתמלל את קובץ האודיו הבא לעברית. אך בנוסף, עליך לזהות את האווירה, המהירות וטון הדיבור של הדובר מתוך הקול שלו. הוסף בתחילת כל משפט או קטע טקסט יותר גדול (לפי הצורך) הנחיית במאי (באנגלית) בתוך סוגריים עגולים. למשל: '(Speaking in a very excited and happy tone) בוקר טוב!'. או: '(Speaking in a calm, slow and serious tone) אני לא מסכים'. החזר אך ורק את הטקסט הסופי עם הסוגריים העגולים באנגלית, ללא שום מילת הקדמה, מרכאות או הסבר נוסף.
חוקים מחייבים:
...
10. הפלט יהיה רק הטקסט המתומלל, ללא הסברים.
